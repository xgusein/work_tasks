                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">ibadzadehuseyn@gmail.com</span>
                            <a href="mailto:ibadzadehuseyn@gmail.com" className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>

                        <div className="contact__card">
                            <i className="bx bxl-whatsapp contact__card-icon"></i>
                            <h3 className="contact__card-title">Whatsapp</h3>
                            <span className="contact__card-data">+994555306095/+905346306095</span>
                        ...
                        <div className="contact__card">
                            ...
                            <h3 className="contact__card-title">Messengers</h3>
                            <span className="contact__card-data">Huseyn Ibadzade</span>
                ...
                <div className="contact__contact">
                    ...
                    <form ref={form} onSubmit={sendEmail} className="contact__form">
                        ...
                        <div className="contact__form-div">
                            ...
                            <input name='email' type="text" placeholder='Insert your email' className="contact__form-input" />
                        </div>
